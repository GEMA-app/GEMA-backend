...
def upgrade() -> None:
    ...
    op.create_table('empresas',
        ...
        sa.Column('estado', sa.Enum('active', 'suspended', 'cancelled', name='companystatus'), nullable=False),
    ...
    op.create_table('permisos',
        ...
        sa.Column('empresa_id', sa.Uuid(), nullable=False),
        sa.Column('rol_id', sa.Uuid(), nullable=False),
        sa.Column('modulo', sa.Enum('assets', 'maintenance', 'inventory', 'reports', 'admin', name='permissionmodule'), nullable=False),
    ...
    op.create_table('ubicaciones',
        ...
        sa.Column('nombre', sa.String(length=255), nullable=False),
        sa.Column('tipo', sa.Enum('headquarters', 'plant', 'area', 'section', name='locationtype'), nullable=False),
        sa.Column('descripcion', sa.Text(), nullable=True),
        sa.Column('created_at', sa.DateTime(timezone=True), nullable=False),
        sa.Column('updated_at', sa.DateTime(timezone=True), nullable=False),
        sa.ForeignKeyConstraint(['empresa_id'], ['empresas.id'], ondelete='CASCADE'),
    ...
    op.create_table('activos',
        ...
        sa.Column('estado', sa.Enum('operational', 'under_maintenance', 'out_of_service', 'decommissioned', name='assetstatus'), nullable=False),
