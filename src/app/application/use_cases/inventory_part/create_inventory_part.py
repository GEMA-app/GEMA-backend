...
from app.application.dtos.inventory_part_dtos import CreateInventoryPartRequest, InventoryPartResponse
from app.application.ports.unit_of_work import UnitOfWorkPort
from app.domain.entities.inventory_part import InventoryPart
from app.domain.value_objects import CompanyId, ArticleId, ProviderId
