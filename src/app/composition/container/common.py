...
# Auditoria generica para todos los modulos
    # un solo handler + un solo UoW por evento. Si algún evento
    # necesita lógica custom (ej: email), se extrae handler dedicado.
    _all_module_events = [
        UserRegistered,
        RoleAssigned,
        RoleRevoked,
    ...
    for evt_type in _all_module_events:
        bus.subscribe(
            evt_type,
            lambda e: handle_generic_audit(e, get_uow()),
        )
